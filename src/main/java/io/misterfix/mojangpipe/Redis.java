...
class Redis {
    static void init(){
        ...
        redis.flushall();
        redis.hmset("proxies", Map.of("3129", "0", "3130", "0", "3131", "0", "3132", "0", "3133", "0", "3134", "0", "3135", "0", "3136", "0"));
        redis.hmset("statusCodes", Map.of("200 OK", "0"));
        redis.hmset("stats", Map.of("profile_from_mem", "0", "profile_from_api", "0", "uuid_from_mem", "0", "uuid_from_api", "0", "names_from_mem", "0", "names_from_api", "0", "name_profile_from_mem", "0", "name_profile_from_api", "0"));
    }
    //=====================STATISTICS=====================//
    static int getRequestsFromMemory(){
        RedisCommands<String, String> redis = MojangPipe.getRedis();
        redis.select(0);
        return Integer.parseInt(redis.hget("stats", "profile_from_mem"))+Integer.parseInt(redis.hget("stats", "uuid_from_mem"))+Integer.parseInt(redis.hget("stats", "names_from_mem"))+Integer.parseInt(redis.hget("stats", "name_profile_from_mem"));
    }
